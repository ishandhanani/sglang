...
class Envs:
    ...
    SGLANG_SHARED_HICACHE_FETCH_WORKERS = EnvInt(8)
    SGLANG_SHARED_HICACHE_TIMEOUT_SECS = EnvFloat(30.0)
    SGLANG_SHARED_HICACHE_TRANSFER_PARALLELISM = EnvInt(8)
    SGLANG_SHARED_HICACHE_TARGET_RESERVE_TOKENS = EnvInt(-1)
