    ...
    def _calculate_spec_decoding_metrics(
        ...
        if (
            ...
            if num_proposed_drafts > 0:
                ...
                # FIXME: backward-compat alias for `spec_num_proposed_drafts`, remove in next release.
            ...
            if (
                ...
                # FIXME: backward-compat alias for `spec_correct_drafts_histogram`, remove in next release.
