...
from sglang.srt.managers.scheduler_components.structs import (
...
class Scheduler(
    ...
    def __init__(
        ...
        self.load_inquirer = SchedulerLoadInquirer(
            ...
            get_spec_total_num_accepted_tokens=lambda: self.metrics_reporter.spec_total_num_accepted_tokens,
    ...
    def init_ipc_channels(self, port_args: PortArgs):
        ...
        self.ipc_channels = SchedulerIpcChannels.create(
            ...
            metrics_enabled=self.current_scheduler_metrics_enabled,
        )
